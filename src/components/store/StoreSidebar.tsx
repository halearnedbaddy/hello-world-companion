...
export type StoreTab = 
  ...
  | 'inventory' | 'inventory-stock' | 'inventory-locations' | 'inventory-reorder'
  | 'customers' | 'customers-all' | 'customers-segments'
  | 'marketing' | 'marketing-email' | 'marketing-sms' | 'marketing-cart-recovery' | 'marketing-loyalty' | 'marketing-discounts' | 'marketing-social'
  | 'analytics' | 'analytics-overview' | 'analytics-forecasting' | 'analytics-customer-insights' | 'analytics-market-intelligence' | 'analytics-custom-reports'
  | 'financial' | 'financial-accounting' | 'financial-tax' | 'financial-payment-options' | 'financial-health'
  | 'live-chat'
  | 'reviews'
  | 'store-settings' | 'store-settings-general' | 'store-settings-domain' | 'store-settings-languages' | 'store-settings-invoices'
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'inventory-reorder', label: 'Reorder Management' },
    ],
  },
  {
    ...
    children: [
      ...
      { id: 'customers-segments', label: 'Segments', plan: 'business' },
    ],
  },
  {
