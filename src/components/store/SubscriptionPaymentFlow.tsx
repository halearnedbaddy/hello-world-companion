  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-card rounded-2xl w-full max-w-md shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        {/* Choose Payment Method - Now only manual options */}
        {step === 'choose-method' && (
          <div className="p-6">
            ...
            <p className="text-sm font-medium text-foreground mb-3">Pay via M-Pesa:</p>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Send to Paybill, then enter your transaction code to verify.</p>
                </div>
              </button>
            </div>
